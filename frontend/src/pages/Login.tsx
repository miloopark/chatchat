...
} from "../services/authService"; // Removed signUpWithEmailPassword, sendUserDataToBackend as not used here
import "../App.css";
  ...
  return (
    ...
    >
      <LoginCard variants={cardVariants}>
        <LoginHeader>
          <LoginTitle>Welcome to chat^2</LoginTitle>
          <LoginSubtitle>Log in to continue your learning journey</LoginSubtitle>
        </LoginHeader>
